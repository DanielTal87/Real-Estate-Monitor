...
def check_chrome_installed():
    ...
    print_header("Checking Chrome/Chromium Installation")
    ...
    # Check if any Chrome is installed
    ...
    print("\n   DrissionPage requires Chrome or Chromium to be installed.")
    ...
    print("\n   You can continue setup, but scrapers won't work until Chrome is installed.")
...
def main():
    ...
    steps = [
        ...
        ("Chrome/Chromium", check_chrome_installed),
